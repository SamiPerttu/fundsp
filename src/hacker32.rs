...
pub fn reverb2_stereo(
    ...
    super::prelude::reverb2_stereo::<f32>(room_size, time, modulation_speed)
}
...
/// - Output 0: reverberated left signal
/// - Output 1: reverberated right signal
pub fn reverb3_stereo(time: f64) -> An<impl AudioNode<Sample = f32, Inputs = U2, Outputs = U2>> {
    super::prelude::reverb3_stereo::<f32>(time)
}
