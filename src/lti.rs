...
pub trait Lti {
    ...
    /// Evaluates frequency response at frequency omega, which is expressed as a fraction of Nyquist (0 <= omega <= 1/2).
    fn response(&self, omega : f64) -> Complex64;

    /// Evaluates magnitude response at frequency omega, which is expressed as a fraction of Nyquist (0 <= omega <= 1/2).
    ...
    /// Evaluates phase response at frequency omega, which is expressed as a fraction of Nyquist (0 <= omega <= 1/2).
